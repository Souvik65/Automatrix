...
const getStatusIcon = (status: ExecutionStatus) => {
    switch (status) {
        case ExecutionStatus.COMPLETED: // Example for completed status
...
export const ExecutionView = ({
    ...
    const [showsStackTrace, setShowsStackTrace] = useState(false);
        ...
        <Card className="shadow-none">
            <CardHeader>
                <div className="flex items-center gap-3 ">
                    ...
                    <div>
                        <CardTitle>
                            Execution {formatStatus(execution.status)}
                            <CardDescription>
                ...
                {execution.error && (
                    <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3">
                        ...
                        {execution.errorStack && (
                            <Collapsible open={showsStackTrace} onOpenChange={setShowsStackTrace}>
